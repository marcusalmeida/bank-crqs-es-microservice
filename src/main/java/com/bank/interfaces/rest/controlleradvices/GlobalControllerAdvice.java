package com.bank.interfaces.rest.controlleradvices;


import com.bank.domain.exceptions.InvalidEmailException;
import com.bank.es.exceptions.AggregateNotFoundException;
import com.bank.exceptions.ExceptionResponseDTO;
import com.bank.exceptions.InternalServerErrorResponse;
import com.bank.exceptions.InvalidAddressException;
...
public class GlobalControllerAdvice {
  ...
  public ResponseEntity<ExceptionResponseDTO> handlerAggregateNotFounExceptions(AggregateNotFoundException ex) {
